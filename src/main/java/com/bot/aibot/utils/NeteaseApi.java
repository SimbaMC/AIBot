...
public class NeteaseApi {
        ...
        try {
            ...
            if (code == 803) {
                if (root.has("cookie") && !root.get("cookie").isJsonNull()) {
                    mergeLoginCookies(root.get("cookie").getAsString());
                }
    ...
    private static void mergeLoginCookies(String cookieHeader) {
        ...
        for (String part : cookieHeader.split(";")) {
            ...
            try {
                ...
                // Ignore malformed response fields without exposing cookie contents.
            }
        }
    }
    ...
    private static boolean isCookieAttribute(String name) {
        return "path".equalsIgnoreCase(name) || "domain".equalsIgnoreCase(name)
                ...
                || "samesite".equalsIgnoreCase(name) || "version".equalsIgnoreCase(name)
                || "comment".equalsIgnoreCase(name) || "secure".equalsIgnoreCase(name)
                || "httponly".equalsIgnoreCase(name) || "discard".equalsIgnoreCase(name);
    }
